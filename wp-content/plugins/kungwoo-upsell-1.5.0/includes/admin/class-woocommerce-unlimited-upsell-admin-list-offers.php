...
class WooCommerce_Unlimited_Upsell_Admin_List_Offers extends WP_List_Table
{
    ...
    public function column_default($item, $column_name)
    {
        switch ($column_name) {
            case 'title':
            case 'status':
                return ($item['is_active'] > 0) ? sprintf('<span class="wooup-active">%s</span>', __('Active', 'woocommerce-unlimited-upsell')) : sprintf('<span class="wooup-not-active">%s</span>', __('Not active', 'woocommerce-unlimited-upsell'));
            default:
