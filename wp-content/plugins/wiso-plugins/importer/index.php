...
if ( ! class_exists( 'wiso_Setup' ) ) {
	class wiso_Setup {
		...
		public function admin_menus() {
			add_theme_page( esc_html__( 'Import Demo Data', 'wiso-plugins' ), esc_html__( 'Import Demo Data', 'wiso-plugins' ), 'manage_options', $this->theme_name . '-setup', array(
				$this,
				'setup_wizard'
			) );
		}
		...
		public function setup_wizard() {
			...
			wp_localize_script( 'envato-setup', 'envato_setup_params', array(
				...
				'verify_text'      => esc_html__( '...verifying', 'wiso-plugins' ),
			) );
			...
			$this->steps = array(
				'introduction' => array(
					'name'    => esc_html__( 'Introduction', 'wiso-plugins' ),
		...
		public function setup_wizard_footer() {
			...
			<?php if ( 'next_steps' === $this->step ) : ?>
                <a class="wc-return-to-dashboard"
                   href="<?php echo esc_url( admin_url() ); ?>"><?php esc_html_e( 'Return to the WordPress Dashboard', 'wiso-plugins' ); ?></a>
			<?php endif; ?>
            </body>
			<?php
		...
		public function envato_setup_introduction() {
			if ( isset( $_REQUEST['export'] ) ) {
				...
				?>
                <h1><?php esc_html_e( 'Current Settings:', 'wiso-plugins' ); ?></h1>
                <p><?php esc_html_e( 'Widget Positions:', 'wiso-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $widget_positions ); ?></textarea>
                <p><?php esc_html_e( 'Widget Options:', 'wiso-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $widget_options ); ?></textarea>
                <p><?php esc_html_e( 'Menu IDs:', 'wiso-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $menu_ids ); ?></textarea>
                <p><?php esc_html_e( 'Custom Options:', 'wiso-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $my_options ); ?></textarea>
                <p><?php esc_html_e( 'Copy these values into your PHP code when distributing/updating the theme.', 'wiso-plugins' ); ?></p>
				<?php
			} else {
				?>
                <h1><?php esc_html_e( 'Welcome to Wiso install!', 'wiso-plugins' ); ?></h1>
                <p><?php esc_html_e( "Everyone hates to install-but you will love this! Our rocket-fast install wizard will do most of the work for you. We'll have a couple of questions along the way, but right now you are ", 'wiso-plugins' ); ?>
                    <u><?php esc_html_e( 'only minutes', 'wiso-plugins' ); ?></u><?php esc_html_e( " away from having an awesome looking blog for the whole world to see.", 'wiso-plugins' ); ?>
                </p>
                <p><?php esc_html_e( 'By the way, if you are slammed for time and can\'t spare 5 minutes right now, no problem! Come back to this "dashboard" page when you have a little more time and we\'ll be waiting right here-ready to go!', 'wiso-plugins' ); ?></p>
                <div class="text-info-server-wrap">
                    <div class="text-info">
		                ...
		                ?>
                        <div class="item-info">
                            <a href="#" class="refresh utton-primary button button-large"><?php esc_html_e('Refresh', 'wiso-plugins'); ?></a>
                        </div>
                        <table>
                            <tr>
                                <td></td>
                                <td><?php esc_html_e('Recommended', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('Actual', 'wiso-plugins'); ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('PHP Version', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('5.6.0', 'wiso-plugins'); ?></td>
                                <td class="<?php echo esc_attr($phpClass); ?>"><?php echo $phpVersion; ?></td>
                            </tr>
                            <tr>
                            <tr>
                                <td><?php esc_html_e('Upload Max Filesize', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('8M', 'wiso-plugins'); ?></td>
                                <td class="<?php echo esc_attr($upload_max_filesizeClass); ?>"><?php echo $upload_max_filesize; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Memory limit', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('128M', 'wiso-plugins'); ?></td>
                                <td class="<?php echo esc_attr($memory_limitClass); ?>"><?php echo $memory_limit; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Max Execution Time', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('120', 'wiso-plugins'); ?></td>
                                <td class="<?php echo esc_attr($max_execution_timeClass); ?>"><?php echo $max_execution_time; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Post Max Size', 'wiso-plugins'); ?></td>
                                <td><?php esc_html_e('8M', 'wiso-plugins'); ?></td>
                ...
                <p class="envato-setup-actions step">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button-primary button button-large button-next"><?php esc_html_e( 'Let\'s Go!', 'wiso-plugins' ); ?></a>
                    <a href="<?php echo esc_url( wp_get_referer() ? wp_get_referer() : admin_url( '' ) ); ?>"
                       class="button button-large"><?php esc_html_e( 'Not right now', 'wiso-plugins' ); ?></a>
                </p>
				<?php
			}
		}
		...
		public function envato_setup_default_plugins() {
			...
			?>
            <h1><?php esc_html_e( 'Default Plugins', 'wiso-plugins' ); ?></h1>
            <form method="post">
				...
				if ( count( $plugins['all'] ) ) {
					?>
                    <p><?php esc_html_e( 'Some of these you Must Have and some of them you\'ll Want to Have...', 'wiso-plugins' ); ?></p>
					...
					echo '<p><strong>' . esc_html__( 'Good news! All plugins are already installed and up to date. Please continue.', 'wiso-plugins' ) . '</strong></p>';
				} ?>

                <p class="envato-setup-actions step">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button-primary button button-large button-next"
                       data-callback="install_plugins"><?php esc_html_e( 'Continue', 'wiso-plugins' ); ?></a>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'wiso-plugins' ); ?></a>
		...
		public function ajax_plugins() {
			if ( ! check_ajax_referer( 'envato_setup_nonce', 'wpnonce' ) || empty( $_POST['slug'] ) ) {
				wp_send_json_error( array(
					'error'   => 1,
					'message' => esc_html__( 'No Slug Found', 'wiso-plugins' )
				) );
			}
			$json = array();
			...
			foreach ( $plugins['activate'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Activating Plugin', 'wiso-plugins' ),
					);
					break;
				}
			}
			foreach ( $plugins['update'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Updating Plugin', 'wiso-plugins' ),
					);
					break;
				}
			}
			foreach ( $plugins['install'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Installing Plugin', 'wiso-plugins' ),
					);
					break;
				}
			}
			...
			if ( $json ) {
				...
				wp_send_json( array( 'done' => 1, 'message' => esc_html__( 'Success', 'wiso-plugins' ) ) );
			}
			exit;
		...
		private function _content_default_get() {
            ...
            $content['widgets'] = array(
                'title' => esc_html__( 'Widgets', 'wiso-plugins' ),
                'description' => esc_html__( 'Cool "widgets" on your sidebar that you will make your page come alive with options.', 'wiso-plugins' ),
                'pending' => esc_html__( 'Pending.', 'wiso-plugins' ),
                'installing' => esc_html__( 'Installing Default Widgets.', 'wiso-plugins' ),
                'success' => esc_html__( 'Success.', 'wiso-plugins' ),
                'install_callback' => '_content_install_widgets',
            );

            $content['codestar'] = array(
                'title' => esc_html__( 'Enable default options', 'wiso-plugins' ),
                'description' => esc_html__( 'Change logo colors, fonts, layout... you know, the cool stuff.','wiso-plugins' ),
                'pending' => esc_html__( 'Pending.','wiso-plugins' ),
                'installing' => esc_html__( 'Installing Default Theme Settings.','wiso-plugins' ),
                'success' => esc_html__( 'Success.','wiso-plugins' ),
                'install_callback' => '_content_install_codestar',
            );

            $content['settings'] = array(
                'title' => esc_html__( 'Settings', 'wiso-plugins' ),
                'description' => esc_html__( 'General settings help you to customize your site.', 'wiso-plugins' ),
                'pending' => esc_html__( 'Pending.', 'wiso-plugins' ),
                'installing' => esc_html__( 'Installing Default Settings.', 'wiso-plugins' ),
                'success' => esc_html__( 'Success.', 'wiso-plugins' ),
                'install_callback' => '_content_install_settings',
            );

            $content['customize'] = array(
                'title' => esc_html__( 'Customize options', 'wiso-plugins' ),
                'description' => esc_html__( "You'll see-more cool stuff to play with.", 'wiso-plugins' ),
                'pending' => esc_html__( 'Pending.', 'wiso-plugins' ),
                'installing' => esc_html__( 'Installing Default Customize Settings.', 'wiso-plugins' ),
                'success' => esc_html__( 'Success.', 'wiso-plugins' ),
            ...
            <form method="post">
                ...
                <div class="envato-setup-pages">
                    <div class="importer-pages-wrap">
						...
						foreach ( $this->_content_default_get() as $slug => $default ) {
							...
							if($slug != 'widgets' &&  $slug != 'codestar' &&  $slug != 'settings' &&  $slug != 'customize'){
                        ...
                        <div class="install-text">
		                    <?php esc_html_e('Installing Demo Data...', 'wiso-plugins'); ?>
                        </div>
                    </div>
                </div>
                ...
                <p class="envato-setup-actions step hide">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       ...
                       data-callback="install_content"><?php esc_html_e( 'Continue', 'wiso-plugins' ); ?></a>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'wiso-plugins' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
                </p>
		...
		public function ajax_content() {
			...
			if ( ! check_ajax_referer( 'envato_setup_nonce', 'wpnonce' ) || empty( $_POST['content'] ) && isset( $content[ $_POST['content'] ] ) ) {
				wp_send_json_error( array(
					'error'   => 1,
					'message' => esc_html__( 'No content Found', 'wiso-plugins' )
				) );
			}
			...
			if ( ! empty( $json ) ) {
				...
				wp_send_json( array( 'error' => 1, 'message' => esc_html__( 'Error', 'wiso-plugins' ) ) );
			}
		...
		private function _content_install_widgets() {
			...
			foreach ( $data as $sidebar_id => $widgets ) {
				...
				if ( isset( $wp_registered_sidebars[ $sidebar_id ] ) ) {
					...
					$sidebar_message      = esc_html__( 'Sidebar does not exist in theme (using Inactive)', 'wiso-plugins' );
				}
				...
				foreach ( $widgets as $widget_instance_id => $widget ) {
					...
					if ( ! $fail && ! isset( $available_widgets[ $id_base ] ) ) {
						...
						$widget_message      = esc_html__( 'Site does not support widget', 'wiso-plugins' ); // explain why widget not imported
					}
					...
					if ( ! $fail && isset( $widget_instances[ $id_base ] ) ) {
						...
						foreach ( $single_widget_instances as $check_id => $check_widget ) {
							...
							if ( in_array( "$id_base-$check_id", $sidebar_widgets ) && (array) $widget == $check_widget ) {
								...
								$widget_message      = esc_html__( 'Widget already exists', 'wiso-plugins' ); // explain why widget not imported
					...
					if ( ! $fail ) {
						...
						$sidebars_widgets                      = (array) get_option( 'sidebars_widgets' ); // which sidebars have which widgets, get fresh every time
						...
						if ( $sidebar_available ) {
							...
							$widget_message      = esc_html__( 'Imported', 'wiso-plugins' );
						} else {
							$widget_message_type = 'warning';
							$widget_message      = esc_html__( 'Imported to Inactive', 'wiso-plugins' );
						}
					...
					$results[ $sidebar_id ]['widgets'][ $widget_instance_id ]['title']        = $widget->title ? $widget->title : esc_html__( 'No Title', 'wiso-plugins' ); // show "No Title" if widget instance is untitled
		...
		public function envato_setup_logo_design() {
			...
			?>
            <h1><?php esc_html_e( 'Logo &amp; Design', 'wiso-plugins' ); ?></h1>
            <form method="post">
                <p><?php esc_html_e( 'Please add your logo below. For best results, the logo should be a transparent PNG ( 190 by 35 pixels). The logo can be changed at any time from the Appearance > Customize area in your dashboard.', 'wiso-plugins' ); ?> </p>
                <table>
                    <tr>
                        <td>
                            <div id="current-logo">
                        ...
                        <td>
                            <a href="#"
                               class="button button-upload"><?php esc_html_e( 'Upload New Logo', 'wiso-plugins' ); ?></a>
                        </td>
                    </tr>
                </table>


                <p><?php esc_html_e( 'Please choose the color scheme for this website. The color scheme (along with font colors &amp; styles) can be changed at any time from the Appearance > Customize area in your dashboard.', 'wiso-plugins' ); ?></p>
                ...
                <p class="envato-setup-actions step">
                    <input type="submit" class="button-primary button button-large button-next"
                           value="<?php esc_attr_e( 'Continue', 'wiso-plugins' ); ?>" name="save_step"/>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'wiso-plugins' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
                </p>
		...
		public function envato_setup_customize() {
            ...
            <h1><?php esc_html_e( 'Theme Customization', 'wiso-plugins' ); ?></h1>
            <p>
				<?php esc_html_e( 'To change the Sidebars go to Appearance > Widgets. You can "drag & drop" the widgets into your sidebar. To control which "widget areas" appear, go to an individual page and look for the "Left/Right Column" menu. Here widgets can be chosen for display on the left or right of a page. More details in documentation.', 'wiso-plugins' ); ?>
            </p>
            <p>
                <em>
					<?php echo sprintf( esc_html__( 'Advanced Users: If you are going to make changes to the theme source code please use a %s rather than modifying the main theme HTML/CSS/PHP code.', 'wiso-plugins' ), '<a href="https://codex.wordpress.org/Child_Themes" target="_blank">Child Theme</a>' ); ?>
					<?php echo sprintf( esc_html__( 'This allows the parent theme to receive updates without overwriting your source code changes.%s See %s in the main folder for a sample.', 'wiso-plugins' ), '<br/>', '<code>child-theme.zip</code>' ); ?>
                </em>
            </p>

            <p class="envato-setup-actions step">
                <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                   class="button button-primary button-large button-next"><?php esc_html_e( 'Continue', 'wiso-plugins' ); ?></a>
            </p>
		...
		public function envato_setup_ready() {
            ...
            <h1><?php esc_html_e( 'Your Website is Ready!', 'wiso-plugins' ); ?></h1>

            <p><?php esc_html_e( 'In the future, if you would like to modify your theme, simply login to your WordPress dashboard, and away you go!', 'wiso-plugins' ); ?></p>

            <div class="envato-setup-next-steps">
                <div class="envato-setup-next-steps-first">
                    <h2><?php esc_html_e( 'Next Steps', 'wiso-plugins' ); ?></h2>
                    <ul>
                        <li class="setup-product"><a class="button button-primary button-large" target="_blank"
                                                     href="<?php echo esc_url( home_url( '/' ) ); ?>"><b><?php esc_html_e( 'VIEW YOUR NEW WEBSITE!', 'wiso-plugins' ); ?></b></a>
                        </li>
                    </ul>
                </div>
                <div class="envato-setup-next-steps-last">
                    <h2><?php esc_html_e( 'More Resources', 'wiso-plugins' ); ?></h2>
                    <ul>
                        <li class="howto"><a href="https://wordpress.org/support/"
                                             target="_blank"><?php esc_html_e( 'Learn how to use WordPress', 'wiso-plugins' ); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
