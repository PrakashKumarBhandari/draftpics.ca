...
*
* Skin Name: Camberra (custom)
* Skin Slug: tg-camberra-custom
* Date: 06/15/18 - 02:04:09PM
*
*/
...
$output = null;
	...
	$output .= $tg_el->get_media();
		...
		$output .= $tg_el->get_media_button(array('icons' => array('image' => '<i class="tg-icon-arrows-out"></i>', 'audio' => '<i class="tg-icon-play"></i>', 'video' => '<i class="tg-icon-play"></i>', 'pause' => '')), 'tg-element-3');
