...
*
* Skin Name: Wiso Andra
* Skin Slug: tg-wiso-andra
* Date: 06/02/18 - 02:40:32PM
*
*/
...
if ($media) {
	...
	if ($image || in_array($format, array('gallery', 'video'))) {
		...
		$output .= $tg_el->get_center_wrapper_start();
			$output .= $tg_el->get_media_button(array('icons' => array('image' => '<i>read more</i>', 'audio' => '<i class="tg-icon-play"></i>', 'video' => '<i class="tg-icon-play"></i>', 'pause' => ''), 'action' => array('type' => 'link', 'link_target' => '_self', 'link_url' => 'post_url', 'custom_url' => '', 'meta_data_url' => '')), 'tg-element-3 read-more');
