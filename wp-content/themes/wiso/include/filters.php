...
add_filter( 'wp_get_attachment_image_attributes', 'wiso_lazy_load' );
if ( ! function_exists( 'wiso_lazy_load' ) ) {
	function wiso_lazy_load( $data ) {
			if (
		...
		return apply_filters( 'wiso_lazy_load', $data );
	}
}

if ( ! function_exists( 'wiso_the_lazy_load_flter' ) ) {
	function wiso_the_lazy_load_flter( $id, $attr = array(), $state = true, $size = 'full', $uri_img = '') {
