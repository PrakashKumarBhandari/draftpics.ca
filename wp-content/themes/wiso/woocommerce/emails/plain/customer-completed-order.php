...
echo sprintf( esc_html__( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'wiso' ), get_option( 'blogname' ) ) . "\n\n";
