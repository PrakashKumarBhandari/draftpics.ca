...
$my_orders_columns = apply_filters( 'woocommerce_my_account_my_orders_columns', array(
	'order-number'  => esc_html__( 'Order', 'wiso' ),
	'order-date'    => esc_html__( 'Date', 'wiso' ),
	'order-status'  => esc_html__( 'Status', 'wiso' ),
	'order-total'   => esc_html__( 'Total', 'wiso' ),
	'order-actions' => '&nbsp;',
) );
...
if ( $customer_orders ) : ?>
	...
	<h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', esc_html__( 'Recent Orders', 'wiso' ) ); ?></h2>
		...
		<thead>
			<tr>
				<?php foreach ( $my_orders_columns as $column_id => $column_name ) : ?>
					<th class="<?php echo  $column_id ; ?>"><span class="nobr"><?php echo esc_html( $column_name ); ?></span></th>
				<?php endforeach; ?>
			</tr>
		</thead>
