			...
			<?php
				foreach ( $grouped_products as $product_id ) :
					...
					<tr>
						...
						<td class="label">
							<label for="product-<?php echo $product_id; ?>">
								<?php if( $product->is_visible() ){ ?>
                                    <a href="<?php echo esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink(), $product_id ) ); ?>"><?php echo get_the_title(); ?></a>
								<?php }else{
							         echo get_the_title();
                                }?>
							</label>
						...
						<td class="price">
							<?php
								echo do_shortcode($product->get_price_html());
